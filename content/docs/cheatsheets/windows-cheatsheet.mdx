...
> **See also:** [Linux](/docs/cheatsheets/linux-cheatsheet) for the Ubuntu/Fedora setup scripts that run inside WSL2.
...
> **See also:** [PowerShell](/docs/cheatsheets/powershell-cheatsheet) for Windows automation, Azure auth, and shell profile configuration.
