...
description: Windows PowerShell snippets for networking, WSL, Scoop, firewall rules, and system administration.
---
...
wsl --unregister Ubuntu-22.04    # remove a distro (destructive)
```
