...
> **See also:** [PowerShell - Azure Authentication](/docs/cheatsheets/powershell-cheatsheet) for Az module equivalents. [Terraform - Provider & Authentication](/docs/cheatsheets/terraform) for using these credentials with the AzureRM provider.
...
> **See also:** [Containers](/docs/cheatsheets/containers-cheatsheet) - kubectl commands, Helm, and AKS-specific patterns for day-2 cluster operations.
...
> **See also:** [KQL](/docs/cheatsheets/kql-cheatsheet) - query language for Log Analytics, Sentinel, and Defender. Covers fundamentals, threat hunting queries, and Sentinel analytic rule patterns.
