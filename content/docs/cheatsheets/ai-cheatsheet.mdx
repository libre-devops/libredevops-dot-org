...
- Cost: premium pay-per-token tier, materially higher than Sonnet; see the Anthropic pricing page
...
| **Claude Mythos** | Deep reasoning, proofs, design | Large | Slow | $$$$ | Expert-level |
...
cost_per_1k_tokens = 0.0  # left at 0 here to avoid baking in stale pricing
