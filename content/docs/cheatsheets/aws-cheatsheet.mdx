...
description: AWS platform engineering reference - CLI mastery, IAM patterns, core services, and operational workflows. Assumes AWS CLI v2 / CDK v2 / boto3 1.34+.
---
...
> **See also:** [Containers](/docs/cheatsheets/containers-cheatsheet) - kubectl day-2 operations, Helm, and Kubernetes manifest patterns that apply to EKS clusters.
