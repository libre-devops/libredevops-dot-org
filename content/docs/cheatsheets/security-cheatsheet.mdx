...
```bash
# WARNING: Destructive capability. Use only with explicit written authorisation and approved scope.
...
### Enable Credential Guard ✅ Current preferred LSASS protection (as of May 2026, requires UEFI + Secure Boot)
...
### Install and configure fail2ban ✅ Current preferred brute-force mitigation (as of May 2026)
