...
description: Production standards for authoring, structuring, testing, and operating PowerShell - coding style and naming, strict mode and error handling, structured logging, logging libraries, OpenTelemetry tracing, Azure telemetry sync, secrets handling and supply-chain security, Pester testing, modules, and CI/CD. Targets PowerShell 7.4+.
---
