...
description: Production standards for writing, structuring, testing, and operating Bash - strict mode and safety, coding style and naming, quoting, functions, error handling and traps, structured logging, observability and Azure telemetry sync, ShellCheck and bats testing, and CI/CD. Targets Bash 4.4+.
---
